...
try:
    ...
    if(t3=='update'):
        ...
        if flag:
            ...
            for a in res:
                if a[3]==None:
                    ...
                    s=a[3]
                print("<tr class=t22><td>"+a[0]+"</td><td>"+a[1]+"</td><td>"+a[2]+"</td><td>"+s+"</td><td>"+str(a[4])+"</td><td>"+str(a[5])+"</td><td>"+str(a[6])+"</td><td>"+str(a[7])+"</td><td>"+str(a[8])+"</td><td>"+str(a[9])+"</td><td>"+str(a[10])+"</td><td>"+str(a[11])+"</td><td>"+str(a[12])+"""</td><td><input class="div7" type="button" name="update" id="up" value="Update"></td></tr>""")
            print("""</table>""")
        else:
        ...
        res=x.fetchall()
        print(""" <select class="div1" id="u_n2" name="uni_name"> <option value="ua" hidden>Select a university</option>""")
        for a in res: 
        ...
        res=x.fetchall()
        print("""<select class="div6" id="c_n2" name="cou_name"> <option value="ma" hidden>Select a Course</option>""")
        for a in res: 
            print("<option>"+a[0]+"</option>")
        print("</select>,,,")
        ####################################################################################################################################################
        ...
        res=x.fetchall()
        print("""<select class="div3" id="m_n2" name="mo_name"> <option value="ma" hidden>Select a mode</option>""")
        p=set()
        for a in res:
            a=a[0].split(',')
            for t in a:
