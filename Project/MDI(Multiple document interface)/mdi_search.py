...
try:
    ...
    if(t=='show'):
        k=f.getvalue('b')
        x.execute("select u_reg,link from university_info where u_name=%s",(k,))
        res=x.fetchall()
        for a in res:
            print(a)
    else:
            ...
            if flag:
                ...
                for a in res:
                    if a[3]==None:
                        ...
                        s=a[3]
                    print("<tr class=t22><td>"+a[0]+"  "+"</td><td>"+a[1]+"  "+"</td><td>"+a[2]+"  "+"</td><td>"+s+"  "+"</td><td>"+str(a[4])+"  "+"</td><td>"+str(a[5])+"  "+"</td><td>"+str(a[6])+"  "+"</td><td>"+str(a[7])+"  "+"</td><td>"+str(a[8])+"  "+"</td><td>"+str(a[9])+"  "+"</td><td>"+str(a[10])+"  "+"</td><td>"+str(a[11])+"  "+"</td><td>"+str(a[12])+"  "+"""</td><td><input class="div7" type="button" name="submit" id="sub" value=""></td></tr>""")
                print("""</table>""")
            else:
